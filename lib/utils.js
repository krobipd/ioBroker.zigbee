...
/**
 * Normalise a list of IEEE addresses as entered in the configuration: an array or a string separated
 * by whitespace, commas or semicolons; '0x' optional, any letter case. Returns the valid addresses as
 * lower-case '0x' strings and the entries that are no IEEE address.
 */
function parseIeeeList(value) {
    ...
    for (const entry of entries) {
        ...
        const ieee = `0x${entry.trim().toLowerCase().replace(/^0x/, '')}`;
