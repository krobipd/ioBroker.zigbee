    ...
    */
    ...
    async configure(options) {
        ...
        if (this.blocklist.size > 0) {
            ...
            // configure() runs twice at start (adapter, then start()); say it once per list
            const active = `Join blocklist active for ${[...this.blocklist].join(', ')}`;
            if (active !== this._blocklistLogged) this.info(active);
            this._blocklistLogged = active;
        }
